...
module TextMate
  module Helpers
    module TagHelper
      ...
      #
      # @param content [String, { Symbol => String }] the content of the tag.
      #   If a block is given this is considered to be the same as options
      #
      # @param options [{ Symbol => String }] this hash will be converted to
      #   HTML attributes
      #
      # @param escape [Boolean] if true will escape HTML. Defaults to true when
      #   no block is given
      #
      # @param block [Proc] if a block is given, the return value will be used
      #   as content
      #
      ...
      #
      # @option options [Boolean] :end_tag (false) if true it will return an
      #   end tag
      #
      # @option options [Boolean] :self_closing (false) if true it will return
      # self closing tag
      #
      # @option options [Boolean] :escape (true) if true will escape HTML
      #
      # @option option [{ Symbol => String }] :options ({}) a hash of options
      #   that will be converted to HTML attributes. Will be ignored if
      #   :end_tag or :self_closing is true
